...
| [openweather](https://github.com/Dash-Caster/data-pumps/openweather) | This service pulls weather data for a specified location using OpenWeatherMap API and pushes the current temperature to your DashCaster board.| Edit `openweather/.env` file according to [these instructions](https://github.com/Dash-Caster/data-pumps/openweather#configuration). |
